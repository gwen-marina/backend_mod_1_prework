...
name = "Gwendolyn"
coding = "the last 9 weeks learning to code, and so far"
data_array = "arrays"
p "I, #{name}, have spent #{coding} and #{data_array} are my favorite data type. Kidding, coding is hard and I have no favorites."
